...
$keluarga = mysqli_query($koneksi, "SELECT * FROM keluarga WHERE id_keluarga='$id_keluarga'");
            ...
            <div class="col-md-12 mt-3">
                <form action="edit_keluarga.php" method="post" name="form1">
                    <table width="100%" class="table-border" cellpadding="10" border="0">
                        <tr>
                            <td>ID Keluarga</td>
                            <td><input type="text" class="form-control" name="id_keluarga" value="<?php echo $row['id_keluarga'];?>"></td>
                        </tr>
                        <tr>
                            <td> Alamat</td>
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="form-control" name="jml_keluarga" value="<?php echo $row['jml_keluarga'];?>"></td>
                        </tr>
                        <tr>
                            <td>Pekerjaan Ayah</td>
                            <td><input type="text" class="form-control" name="pekerjaan_ayah" value="<?php echo $row['pekerjaan_ayah'];?>"></td>
                        </tr>
                        <tr>
                            <td>Pekerjaan Ibu</td>
                            <td><input type="text" class="form-control" name="pekerjaan_ibu" value="<?php echo $row['pekerjaan_ibu'];?>"></td>
                        </tr>
                        <tr>
                            <td>Penghasilan</td>
                            <td><input type="number" class="form-control" name="penghasilan" value="<?php echo $row['penghasilan'];?>"></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td><input type="submit" class="btn btn-primary" name="Submit" value="Perbarui Data"></td>
                        </tr>
                    </table>
                </form>
            </div>
