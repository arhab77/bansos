...
$row = mysqli_fetch_array($penerima);

//membuat data jurusan menjadi dimamis dalam bentuk array
            ...
            <div class="col-md-12 mt-3">
                <form action="edit.php" method="post" name="form1">
                    <table width="100%" class="table-border" cellpadding="10" border="0">
                        <tr>
                            <td>ID Penerima</td>
                            <td><input type="text" class="form-control" name="id_penerima" value="<?php echo $row['id_penerima'];?>"\></td>
                        </tr>
                        <tr>
                            <td>ID Keluarga</td>
                            <td>
                                <select name="id_keluarga" class="form-control" id="">
                                    <?php
                        ...
                        <tr>
                            ...
                            <td><input type="date" class="form-control" name="tgl_terima" value="<?php echo $row['tgl_terima'];?>"></td>
                        </tr>
                        <tr>
                            <td></td>
