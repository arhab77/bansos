          ...
          <div class="row">
            ...
            <div class="col-xxl-6 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title"><a href="penerima.php">Penerima Bantuan</a><span>| Hari Ini</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><a href="penerima.php">
                        <?php
                          include 'connect.php';
                          $penerima = mysqli_query($koneksi, "SELECT COUNT(id_penerima) FROM `penerima`");
                          
                          while ($brs = $penerima->fetch_assoc()) {
                            echo $brs['COUNT(id_penerima)']." Orang <br>";
                          }
                        ?>
                      </a></h6>
            ...
            <div class="col-xxl-6 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title"><a href="warga.php">Warga</a><span>| Tahun Ini</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><a href="warga.php">
                        <?php
                          include 'connect.php';
                          $warga = mysqli_query($koneksi, "SELECT COUNT(id_keluarga) AS keluarga FROM `keluarga`");
                          
                          while ($bar = $warga->fetch_assoc()) {
                            echo $bar['keluarga']." Orang <br>";
                          }
                        ?>
                      </a></h6>
                    </div>
