...
<!-- End Forms Nav -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Warga Penerima Bansos</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item active">Warga Penerima Bansos</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                ...
                <table class="table table-bordered border-dark" border="1">
                    <thead>
                        <tr>
                            ...
                            <td class="text-center">ID Penerima</td>
                            <td class="text-center">ID Keluarga</td>
                            <td class="text-center">Nama Keluarga</td>
                            <td class="text-center">Alamat</td>
                            <td class="text-center">ID Bantuan</td>
                            <td class="text-center">Tanggal Terima</td>
                    ...
                    <tbody>
                        ...
                        $penerima = mysqli_query($koneksi, "SELECT * FROM penerima 
                                  JOIN keluarga ON penerima.id_keluarga=keluarga.id_keluarga 
                                  JOIN bantuan ON penerima.id_bantuan=bantuan.id_bantuan
                                  JOIN alamat ON keluarga.id_alamat=alamat.id_alamat");
                        $no = 1;
                        ...
                        foreach ($penerima as $row){
                          echo "<tr class='text-center'>
                                    ...
                                    <td><a href='perbarui_penerima.php?id_penerima=$row[id_penerima]' class='btn btn-warning'><i class='bi bi-pencil-square'></i></a>
                                        <a href='delete.php?id_penerima=$row[id_penerima]' class='btn btn-danger'><i class='bi bi-trash'></i></a>
                                    </td>
                                </tr>";
                            $no++;
                         }
