    ...
    <section class="section dashboard">
      <div class="row">
            <div class="col-md-12 mt-3">
                <form action="simpan_keluarga.php" method="post" name="form1">
                    <table width="100%" class="table-border" cellpadding="10" border="0">
                        <tr>
                            <td>ID Keluarga</td>
                            <td><input type="text" class="form-control disable" name="id_keluarga" disabled></td>
                        </tr>
                        <tr>
                            <td>Nama Keluarga</td>
                        ...
                        <tr>
                            <td>Alamat</td>
                            <td>
                                <select name="id_alamat" class="form-select">
                                    <option value="">--pilih--</option>
                                        <?php
                                            include 'connect.php';
                                            $sql_alamat = mysqli_query($koneksi,"SELECT * FROM alamat") or die (mysql_error($koneksi));

                                            while($data_alamat = mysqli_fetch_array($sql_alamat)){
                                                echo '<option value="'.$data_alamat['id_alamat'].'">'.$data_alamat['nama_jln'].'</option>';
                                            };
                                        ?>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="form-control" name="jml_keluarga"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Penghasilan</td>
                            <td><input type="number" class="form-control" name="penghasilan"></td>
                        </tr>
                        <tr>
                            <td></td>
