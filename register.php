            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h3 class="card-title text-center pb-1 fs-3">Register</h3>
                    <p class="text-center small">Silahkan isi form dibawah untuk membuat akun</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Silahkan masukkan alamat Email yang benar</div>
                    </div>
